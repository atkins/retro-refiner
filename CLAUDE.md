...
Test files:
- `tests/test_selection.py` - 177 unit tests: ROM parsing, selection, filtering, config, playlists, transfers, size budget, english-only, multi-disc games, systems.json validation
