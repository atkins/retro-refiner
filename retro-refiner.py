...
# Destination directory (default: <source>_refined)
# dest: /path/to/output
...
Pattern examples (--include / --exclude):
  ...
  --exclude "*(Japan)*"              # Exclude Japan-only releases
    ...
    parser.add_argument('--dest', '-d', default=None,
                        help='Destination directory (default: <source>_refined)')
    ...
    if args.dest is None:
        args.dest = str(primary_source.parent / (primary_source.name + '_refined'))
