...
class RetroRefinerGUI:
    ...
    def _create_selection_tab(self):
        ...
        self._include_listbox = tk.Listbox(inc_frame, height=3, font=MONO_FONT_SMALL)
        ...
        self._exclude_listbox = tk.Listbox(exc_frame, height=3, font=MONO_FONT_SMALL)
        ...
        self._dedup_pc_listbox = tk.Listbox(pc_frame, height=2, font=MONO_FONT_SMALL)
